...
// `sharedParser`/`syntax` below are still used by analyzeShellCommand until
// that helper moves with the policy evaluator (Day 8).
...
export const normalizeCommandForPolicy = engineNormalizeCommandForPolicy;
export const detectDangerousShellExec = engineDetectDangerousShellExec;
/** @deprecated Use detectDangerousShellExec — kept for backwards compatibility */
export const detectDangerousEval = engineDetectDangerousShellExec;
